...
class Top_Travel_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'top_travel';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'top-travel' ), $i ),
...
// Initialize.
$top_travel_footer_widgets = new Top_Travel_Footer_Widgets();
